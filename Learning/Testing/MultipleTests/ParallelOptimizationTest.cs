// ------------------------------------------
// ParallelOptimizationTest.cs, Learning
// 
...
namespace Learning.Testing.MultipleTests
{
    ...
    public abstract class ParallelOptimizationTest : ITest, IProgressHandler
    {
        ...
        {
            get { return String.Format("{0}{1}{2}", this.filePath, Path.DirectorySeparatorChar, this.TestID); }
        }
        ...
        protected virtual string GetLogFilePath(string fileName, string extension)
        {
            return string.Format("{0}{1}{2}{3}.{4}",
                this.FilePath, Path.DirectorySeparatorChar, fileName, this.TestID, extension);
        }

        protected virtual void PrintTestPerformanceResults()
        {
            this.WriteLine(string.Format("{0} has finished.", this.TestID));
        ...
        protected virtual void ResetTest()
        {
            ...
            this.WriteLine(@"==========================================");
            this.WriteLine(string.Format("Running {0}...", this.TestID));
        }
